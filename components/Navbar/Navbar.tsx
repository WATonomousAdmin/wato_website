...
interface NavBarProps {
    toggleModal(): any;
    mobileOpen: boolean;
    setMobileOpen(open: boolean): any;
    dark?: boolean;
}

const Navbar = ({ toggleModal, mobileOpen, setMobileOpen, dark }: NavBarProps) => {
    const toggleMobile = () => setMobileOpen(!mobileOpen);
    const closeMobile = () => setMobileOpen(false);

    return (
        <div className="align-center fixed z-40 flex w-full justify-between lg:mx-12 lg:mt-10 lg:w-[calc(100vw-6rem)] xl:mx-32 xl:w-[calc(100vw-16rem)]">
