...
const HERO_SUBTITLE_PLACEHOLDER = "Help support WATonomous to change the world.";
...
const Sponsor = () => {
    return (
        <div className={`overflow-hidden scroll-smooth bg-cover`}>
            <Hero title={HERO_TITLE_PLACEHOLDER} subtitle={HERO_SUBTITLE_PLACEHOLDER} cta="Request to Sponsor" link="#rts" image="bg-SponsorHero"/>
            <BigDeck
                title={DECK_TITLE}
